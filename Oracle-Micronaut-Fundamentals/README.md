...
# 1.2. Micronaut Documentation

- Its build for every version of Micronaut and is always up to date so we can find the latest features and still view older versions and implementations of the framework and its modules.
